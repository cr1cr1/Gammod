...
{
    [Designer("MetroFramework.Design.Controls.MetroTileCustomDesigner, " + AssemblyRef.MetroFrameworkDesignSN)]
    [ToolboxBitmap(typeof(Button))]
    public class MetroTileCustom : Button, IContainerControl, IMetroControl
    {
        #region Interface
